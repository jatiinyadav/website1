...
const StreakCounter: React.FC<StreakCounterProps> = ({ count }) => {
  return (
    <div className="absolute top-[50%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-black/20 backdrop-blur-sm px-4 py-2 rounded-full flex items-center gap-2 shadow-lg z-2">
